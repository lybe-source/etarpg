 ...
 */
final class Version20231221182419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inventory_items (inventory_id INT NOT NULL, items_id INT NOT NULL, INDEX IDX_3D82424D9EEA759 (inventory_id), INDEX IDX_3D82424D6BB0AE84 (items_id), PRIMARY KEY(inventory_id, items_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `items` (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, rarity_id INT NOT NULL, name VARCHAR(30) NOT NULL, description VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_E11EE94D12469DE2 (category_id), INDEX IDX_E11EE94DF3747573 (rarity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE items_statistics (items_id INT NOT NULL, statistics_id INT NOT NULL, INDEX IDX_7CCBB5156BB0AE84 (items_id), INDEX IDX_7CCBB5159A2595B2 (statistics_id), PRIMARY KEY(items_id, statistics_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE inventory_items ADD CONSTRAINT FK_3D82424D9EEA759 FOREIGN KEY (inventory_id) REFERENCES `inventory` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE inventory_items ADD CONSTRAINT FK_3D82424D6BB0AE84 FOREIGN KEY (items_id) REFERENCES `items` (id) ON DELETE CASCADE');
